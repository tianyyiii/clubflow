...
CREATE TABLE `habbit` (
  ...
  `habbitName` varchar(80) DEFAULT NULL,
  `habbitInfo` text,
  ...
  CONSTRAINT `habbitCreator` FOREIGN KEY (`creator`) REFERENCES `account` (`id`) ON DELETE NO ACTION ON UPDATE NO ACTION
...
INSERT INTO `habbit` VALUES (1,'puzzle habbit','solving puzzle','2015-12-20 10:01:00',2,1,NULL);
