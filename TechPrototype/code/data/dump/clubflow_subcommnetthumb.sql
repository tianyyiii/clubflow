...
CREATE TABLE `subcommnetthumb` (
  ...
  KEY `subcommnetThumber_idx` (`thumberId`),
  CONSTRAINT `subcommnetThumber` FOREIGN KEY (`thumberId`) REFERENCES `account` (`id`) ON DELETE NO ACTION ON UPDATE NO ACTION,
  CONSTRAINT `thumbSubcomment` FOREIGN KEY (`subcommmentId`) REFERENCES `subcomment` (`subcommentId`) ON DELETE NO ACTION ON UPDATE NO ACTION
