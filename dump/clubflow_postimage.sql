...
CREATE TABLE `postimage` (
  ...
  KEY `PostImage_idx` (`imageId`),
  CONSTRAINT `ImagePost` FOREIGN KEY (`postId`) REFERENCES `post` (`postId`),
  CONSTRAINT `PostImage` FOREIGN KEY (`imageId`) REFERENCES `image` (`imageId`)
