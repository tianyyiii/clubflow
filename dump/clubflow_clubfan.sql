...
CREATE TABLE `clubfan` (
  ...
  KEY `ClubFan_idx` (`fanid`),
  CONSTRAINT `ClubFan` FOREIGN KEY (`fanid`) REFERENCES `account` (`id`),
  CONSTRAINT `FanClub` FOREIGN KEY (`clubid`) REFERENCES `club` (`clubId`)
...
INSERT INTO `clubfan` VALUES (1,3,'2015-12-20 10:01:00',1),(1,8,'2023-01-01 16:44:10',1);
