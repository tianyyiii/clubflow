<template>
    ...
    <div class="container-fluid position-relative" style="background-color:rgba(102, 102, 102, 1); height: 300px;">
        ...
        <button id="upcover" class="upimg">
            ...
            <p class="mb-0" style="font-size:14px;">
                <span style="font-family:'微软雅黑', sans-serif;font-weight:400;">上传封面</span>
            </p>
        </button>
    </div>

    <!-- 标题栏 -->
    <div class="my-3 d-flex px-3 pb-3 mx-4 align-items-center" style="border-bottom: rgb(233, 233, 233) 1px solid;">
        <div class="mx-5 d-inline-flex align-items-center">
            <!-- 头像 -->
            <div class="me-4" style="font-family:'FontAwesome', sans-serif;font-size:80px;color:#CCCCCC;">
                <span></span>
            </div>
            <!-- 标题 -->
            <div class="">
                <p class="mb-0" style="font-size:18px;">
                    <span style="font-family:'微软雅黑 Bold', '微软雅黑 Regular', '微软雅黑', sans-serif;font-weight:700;color:#666666;">爱好社区名称</span>
                </p>
                <p class="mb-0" style="font-size:14px;">
    ...
    <div class="my-5 px-5 mx-5 py-3">
        ...
        <div class="" >
            <span class="ms-2 me-2" style="font-family:'FontAwesome', sans-serif;font-size:22px;"></span>
            <span style="font-family:'Microsoft JhengHei UI', sans-serif;font-size:16px;color:#B82D29;">提交创建或更改</span>
            <div class="mt-1" style="background-color:rgb(228, 228, 228); height: 8px;"></div>
        </div>
        <!-- 按钮组 -->
